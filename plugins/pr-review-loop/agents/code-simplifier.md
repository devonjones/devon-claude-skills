...
builds the simplification it proposes and runs the existing checks against it; labels "this is not worth its length" as judgement. Report what you observed, not what you expect. A finding you could not
